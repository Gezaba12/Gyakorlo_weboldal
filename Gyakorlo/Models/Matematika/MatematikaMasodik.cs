...
{
    public class MatematikaMasodik : IMatematika
    {
        ...
        public MatematikaMasodik(FeladatlapGeneralasViewModel feladatlap)
        {
        ...
        public MatematikaMasodik(int db)
        {
        ...
        Feladat Osszeadas()
        {
            int szam1 = rnd.Next(5, 90);
            int szam2 = rnd.Next(8, 100 - szam1);
            int helyesValasz;
            string keplet = "";
