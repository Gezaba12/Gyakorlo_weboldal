...
{
    public class MatematikaHarmadik : IMatematika
    {
        ...
        public MatematikaHarmadik(FeladatlapGeneralasViewModel feladatlap)
        {
        ...
        Feladat Osszeadas()
        {
            int szam1 = rnd.Next(100, 800);
            int szam2 = rnd.Next(100, 1000 - szam1);
            int helyesValasz;
            string keplet = "";
        ...
        Feladat Szorzas()
        {
            int szam1 = rnd.Next(1, 15);
            int szam2 = rnd.Next(1, 15);
            int helyesValasz;
            string keplet = "";
